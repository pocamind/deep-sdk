...
impl Stat {
    ...
    pub fn from_name(name: &str) -> Option<Self> {
        ...
        match name.as_str() {
            ...
            "HEAVY WEP." | "HEAVY" | "HEAVY WEAPON" => Some(Stat::HeavyWeapon),
            "MEDIUM WEP." | "MEDIUM" | "MEDIUM WEAPON" => Some(Stat::MediumWeapon),
            "LIGHT WEP." | "LIGHT" | "LIGHT WEAPON" => Some(Stat::LightWeapon),
